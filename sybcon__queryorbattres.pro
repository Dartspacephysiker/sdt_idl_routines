;+
;FUNCTION: sybcon::queryorbattres(sdatetime, edatetime)
; Class:  sybcon
; Method: queryorbattres
;
...
;
; "sybcon::queryorbattres" replaces the second "sybcon->send"
; call from "get_fa_orbatt.pro".
;

FUNCTION sybcon::queryorbattres, sdatetime, edatetime, qty_list, name
...
self.ncols = call_external(lmdls6, 'sybqueryorbattres', self.dbproc, $
	sdatetime, edatetime, qty_list)
