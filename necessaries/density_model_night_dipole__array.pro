...
function density_model_night_dipole__array,r
...
densArr = MAKE_ARRAY(3,N_ELEMENTS(altArray),VALUE=0.0)

FOR k=0,N_ELEMENTS(altArray)-1 DO BEGIN
   ...
   densArr[*,k] = [no_ionos,nh_ps,nh_ionos]
ENDFOR
