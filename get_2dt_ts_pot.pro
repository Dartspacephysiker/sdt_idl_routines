;+
;PROGRAM:	get_2dt_ts_pot,funct,get_dat
;INPUT:	
...
;       sc_pot:         Array containing s/c potential values
;
;PURPOSE:
...
;CREATED BY:
;	J.McFadden
;LAST MODIFICATION:  14/09/24
;MOD HISTORY:	
;		97/05/16	Variation on get_2dt.pro that uses get_*_ts.pro routines
;
;               14/09/24        SMH attempt to incorporate s/c
;potential measurements as lower bound on E flux
;NOTES:	  
;	Current version only works for FAST

;HELPFUL INFO:
;The following lines all come from alfven_stats_3.pro, where I have
;to comment them out because I don't currently have access to
;get_2dt_ts_pot:
