;+
;FUNCTION: sybcon::queryorbitnscrossings(orbit, name)
; Class:  sybcon
; Method: queryorbitnscrossings
;
...
;
; "sybcon::queryorbitnscrossings" replaces the second
; "sybcon->send" call from "get_fast_orbit_times_db.pro".
;

FUNCTION sybcon::queryorbitnscrossings, sdatetime, edatetime, name
...
self.ncols = call_external(lmdls6, 'sybqueryorbitnscrossings', self.dbproc, $
	sdatetime, edatetime)
