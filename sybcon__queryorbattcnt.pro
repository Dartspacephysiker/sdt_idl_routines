;+
;FUNCTION: sybcon::queryorbattcnt(sdatetime, edatetime)
; Class:  sybcon
; Method: queryorbattcnt
;
...
;
; "sybcon::queryorbattcnt" replaces the first "sybcon->send"
...
self.ncols = call_external(lmdls6, 'sybqueryorbattcnt', self.dbproc, $
	sdatetime, edatetime)
