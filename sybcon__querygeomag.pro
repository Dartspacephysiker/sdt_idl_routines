;+
;FUNCTION: sybcon::querygeomag(sdatetime, edatetime, name)
; Class:  sybcon
; Method: querygeomag
;
...
;
; "sybcon::querygeomag" replaces the "sybcon->send" calls
; from "geomag.pro".
;
...
self.ncols = call_external(lmdls6, 'sybquerygeomag', self.dbproc, $
	sdatetime, edatetime)
