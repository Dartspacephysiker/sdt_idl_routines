...
;
;CREATED BY:
;	S.Hatch 	16-5-13		Treats FAST fast survey narrow beams correctly, calls j_2d_b_en.pro
;LAST MODIFICATION:
;-
function j_2d_fs_en,dat,ENERGY=en,ERANGE=er,EBINS=ebins,ANGLE=an,ARANGE=ar,BINS=bins
...
j1=j_2d_b_en(dat1,ENERGY=en,ERANGE=er,EBINS=ebins,ANGLE=an,ARANGE=ar,BINS=bins)
j2=j_2d_b_en(dat2,ENERGY=en,ERANGE=er,EBINS=ebins,ANGLE=an,ARANGE=ar,BINS=bins)
